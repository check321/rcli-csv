use std::fs;
use clap::Parser;
use rcli_csv::{csv_process, process_genpass, process_encode, process_decode, Opts, SubCommand, Base64SubCommand, TextSubCommand, process_sign, process_verify, process_generate, TextSignFormat};
